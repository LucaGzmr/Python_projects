    ...
    def verschlüssele(satz):    
        ...
        for buchstabe in satz: 
            ...
            # wird bestimmt, dass der Buchstabe generell groß ist spezifisch bezogen auf die individuellen Infos
                ...
                if buchstabe.isdigit() and (int(buchstabe) == 0):
                    statt_null = "#" + "A"
                    übersetzung = übersetzung + statt_null

                elif buchstabe.isdigit() and (int(buchstabe) == 1):
                    übersetzung = übersetzung + "#" + "B"
